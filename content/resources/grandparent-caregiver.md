...
days are ordinary. The point of this guide is not to scare you. It's to
help you feel confident on the rare day when something happens.
...
Where it lives, what it looks like, how to use it. The parent will show
you the trainer device (no needle, no medication) so you can practice
once on a pillow. **Practice once.** That's enough.

The basic motion: cap off, firm push into the outer thigh through clothing,
hold for the count specified on the device, remove. Then call 911.

### 3. When to use it

You're looking for any of these after the child has been around food:

- Trouble breathing or breathing that sounds different
- Throat tightening, hoarse voice, coughing that won't stop
...
### 4. How to read a label (the short version)
...
- **Hand sanitizer or hand wipes don't remove food proteins** as well as
  soap and water. After eating, soap and water hands.
...
- **A small amount can still cause a big reaction.** This is why
  ...
  matters. Cleaning surfaces and using fresh utensils helps a lot.
- **Antihistamines (Benadryl) are not a substitute for the auto-injector.**
  They help with mild skin reactions. They don't treat anaphylaxis.
...
- **When in doubt, call.** The parent would rather get a "is this OK?"
  text than find out something happened.

## Building confidence

The first few times caring for an allergic child can feel intimidating.
After a few weeks it gets normal. The parent has been doing this every
day; they have shortcuts and rhythms that you'll pick up.

You're not expected to know everything. You're expected to ask, learn,
and act fast if something goes wrong. That's all.
